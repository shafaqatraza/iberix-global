...
// Use HashRouter for static hosting (GitHub Pages), BrowserRouter for Base44
const Router = import.meta.env.VITE_HOSTING_MODE === 'frontend-only' ? HashRouter : BrowserRouter;
